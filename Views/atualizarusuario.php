            ...
            <fieldset>
              <form method="post" action="../DAO/atualizarusuariodb.php">            
                <div>
                  ...
                  <input name="nome" class="form-control input-sm" placeholder="Diga o Nome" onkeyup="somenteNomes(this);" type="text" ng-model="nomes.valor" required="required" value="<?php echo $nome?>"/>
                  <label>e-mail</label>
