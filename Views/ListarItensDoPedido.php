                   ...
                   while ($linha = mysqli_fetch_array($TodosItensDoPedido)) {
                     echo " <tr>
                      ...
                      echo"
                          ...
                          <td align=\"center\">
                          <a class=\"btn btn-warning\" href=\"AtualizarItemDoPedido.php?SQ_PEDIDO=$linha[SQ_PEDIDO]&VL_QUANTIDADE=$linha[VL_QUANTIDADE]&DS_ITEM=$linha[DS_ITEM]&DS_COR=$linha[DS_COR]&DT_CADASTRO=$linha[DT_CADASTRO]&SL_CORTE=$linha[SL_CORTE]&ST_ETIQUETA=$linha[ST_ETIQUETA]&ST_SILK=$linha[ST_SILK]&ST_BORDADO=$linha[ST_BORDADO]&DS_PREPARACAO=$linha[DS_PREPARACAO]&ID_TIPOMATERIAL=$linha[ID_TIPOMATERIAL]&ID_PEDIDO=$linha[ID_PEDIDO]\">Editar</a>
                          ...
                          <a class=\"btn btn-success\" href=\"ImprimirCodigodeBarraP.php?ID_ITENSPEDIDO=$linha[ID_ITENSPEDIDO]& CD_BARRASP=$linha[CD_BARRASP]&DS_ITEM=$linha[DS_ITEM]\" target='blank'>Código</a>
                          </td>";
                      echo "</tr>";
                      }
                      ?>
